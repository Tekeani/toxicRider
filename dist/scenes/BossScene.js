...
export class BossScene extends Scene {
    constructor(game) {
        ...
        this.bossX = 200;
        this.bossY = 0;
        this.introDialogueLines = ["Je suis la puissante Amar"];
        this.victoryDialogueLines = ["Aaaaargh ! Je suis vaincue ! Je ne peux plus m'interposer entre toi et ton véritable amour ! *s'effondre*"];
        this.defeatDialogueLines = ["HA-HA ! Je le savais ! Tu m'aimes ! Allons donc vivre ensemble, nous marier et adopter plein de mignons petits chats ! Sans oublier tous les beaux voyages que je nous prévois. Viens !"];
        this.bossPhrases = [
            {
                text: "Je t'aime !",
                answers: [
    ...
    renderDungeonFloor(renderer, size) {
