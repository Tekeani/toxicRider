...
export class RiddleScene extends Scene {
    constructor(game) {
        ...
        this.resultText = '';
        this.gameOverText = "Tu t'es trompé ! Tu dois te retourner, te défroquer, te pencher et... *rire machiavélique*";
        this.gameOver = false;
        this.buttonPressed = false;
        this.bossTransitionActive = false;
        this.bossTransitionTimer = 0;
        this.bossTransitionDuration = 1.0;
        this.castleX = 400;
        this.castleY = 200;
        this.castleWidth = 224;
        this.castleHeight = 280;
        ...
        return new Promise((resolve, reject) => {
            ...
            img.onload = () => {
                if (img.complete && img.naturalWidth > 0) {
                    ...
                    this.npc.animations = {
                        idle: new Animation(this.npc.spriteSheet, [6], 1, true)
                    };
    ...
    renderTransition(renderer, size) {
...
//# sourceMappingURL=RiddleScene.js.map