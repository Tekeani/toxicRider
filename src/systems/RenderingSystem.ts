...
export class RenderingSystem {
    ...
    renderEntity(entity: RenderableEntity): void {
        ...
        if (entity.shouldFlipX()) {
            ...
            this.renderer.drawImage(
                spriteSheetObj.image,
                clampedSourceX, clampedSourceY, frameWidth, frameHeight,
    ...
    renderText(text: string, x: number, y: number, font: string, color: string, align: CanvasTextAlign = 'left'): void {
        this.renderer.fillStyle = color;
